...
Parsley.addMessages('fa', {
    ...
    uppercase:      "باید حداقل شامل %s کاراکتر حرف بزرگ (uppercase) باشد",
    lowercase:      "باید حداقل شامل %s کاراکتر حرف کوچک (lowercase) باشد",
    number:         "باید حداقل شامل %s عدد باشد"
});
